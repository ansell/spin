...
public class QueryWrapper extends CommandWrapper {
	...
	public QueryWrapper(Query query, Resource source, String text, org.topbraid.spin.model.Query spinQuery, String label, Statement statement, boolean thisUnbound) {
